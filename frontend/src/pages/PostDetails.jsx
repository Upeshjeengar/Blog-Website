        ...
        loader?<div className='h-[80vh] flex justify-center items-center w-full  '>
          ...
          <div className="border p-3 shadow">
            ...
            <div className="w-[100%] flex flex-col justify-center  ">
              ...
              <p className='mx-auto mt-8 w-[80vh] p-5 shadow-xl '>{post.desc}</p>
            ...
            <div className="flex justify-center items-center p-3 flex-col mt-4">
              ...
              <div className='border flex justify-center flex-col mt-4 md:flex-row '>
                <input onChange={(e)=>SetComment(e.target.value)} type="test"
                placeholder="write your comment"
                className='md:w-[80%] outline-none py-2 px-4 mt-4 md:mt-0 '
                />
                <button onClick={postComment} className='bg-black text-sm text-white font-semibold px-2 py-2 md:w-[50%] mt-4 md:mt-0 '>
                  Add Comment
                </button>
              </div>
            </div>
